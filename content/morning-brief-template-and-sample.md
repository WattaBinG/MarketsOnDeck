...
2. **Both accounts, not just Trading** — pull positions from BOTH the Trading account (account_number Trading,
   mask to •••8840) AND the Agentic account (account_number Agentic, mask to •••1117) via
